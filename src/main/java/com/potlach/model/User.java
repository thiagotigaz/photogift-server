...
public class User extends AbstractEntity implements UserDetails, Serializable {
	...
	private Integer numberOfGifts=0;
	private Long numberOfTouches=0l;
	@OneToMany(mappedBy="createdBy")
	@JsonBackReference
	private List<LikeTouch> likeTouches;
	...
	public void setNumberOfTouches(Long numberOfTouches) {
		this.numberOfTouches = numberOfTouches;
	}

	public List<LikeTouch> getLikeTouches() {
		return likeTouches;
	}

	public void setLikeTouches(List<LikeTouch> likeTouches) {
